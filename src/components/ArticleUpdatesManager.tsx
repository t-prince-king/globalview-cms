...
import { Plus, Edit, Trash2, X, Upload, Eye, Save } from "lucide-react";
...
export const ArticleUpdatesManager = ({ articleId, articleSlug }: ArticleUpdatesManagerProps) => {
        ...
        {showForm && (
          <div className="p-4 border border-slate-700 rounded-lg space-y-4">
            ...
            <Textarea
              ...
              placeholder="Write your update content here... You can use multiple paragraphs."
